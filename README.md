...
- единая версия `26.6.9` во frontend, backend, service worker, smoke-test и документации;

English/i18n polish in v26.6.9:
...
Test/config stabilization in v26.6.9:
...
CI permission stabilization in v26.6.9:
