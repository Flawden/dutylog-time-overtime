...
- единая версия `26.6.3` во frontend, backend, service worker, smoke-test и документации;
...
- настройки модулей компактнее: технические детали скрыты, бейджи не налезают на текст, выключенные модули не растягивают карточки.
