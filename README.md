...
- Настройки стали отдельными секциями: смены, быстрые сценарии, важные дни и уведомления.
...
- Важные дни добавляются в настройках с явной датой; в панели дня показываются только события выбранной даты.
