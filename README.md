...
Current release: **v27.2.3 — Calendar cache/render hotfix**.: Time & Overtime
...
## Текущая версия: v27.2.3 — Calendar persistence hotfix
...
- [`docs/RELEASE_CANDIDATE.md`](docs/RELEASE_CANDIDATE.md) — что проверено в v27.2.3 и как принимать RC.
...
CI permission stabilization in v27.2.3:
