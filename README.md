...
Новый пользователь сначала проходит спокойную настройку модулей: минимум, работа + переработки или полный набор. Состояние хранится в профиле, существующих пользователей миграция не трогает, а отключение модулей по-прежнему не удаляет данные.
