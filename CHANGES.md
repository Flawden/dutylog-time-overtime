...
- Добавлена ручная синхронизация из панели, повтор ошибочных операций и удаление ошибок из списка.
- Добавлен emergency export локального offline-состояния в JSON: snapshot, очередь, meta и сведения браузера.
