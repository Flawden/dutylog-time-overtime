...
public class PayrollSnapshot {
    ...
    public PayrollSnapshot(AppUser owner, LocalDate periodMonth, int revision,
        ...
        this.owner = owner; this.periodMonth = periodMonth.withDayOfMonth(1); this.revision = revision;
        this.currencyCode = currencyCode; this.hourlyRateMinor = hourlyRateMinor; this.payMode = payMode;
        this.compensationEffectiveFrom = compensationEffectiveFrom.withDayOfMonth(1);
        this.configuredHourlyRateMinor = configuredHourlyRateMinor; this.monthlySalaryMinor = monthlySalaryMinor;
        this.productionNormMinutes = productionNormMinutes; this.salaryCoveredMinutes = salaryCoveredMinutes;
        this.plannedMinutes = plannedMinutes; this.workedMinutes = workedMinutes; this.vacationMinutes = vacationMinutes;
        this.sickMinutes = sickMinutes; this.overtimeCompensatedMinutes = overtimeCompensatedMinutes;
        this.unpaidMinutes = unpaidMinutes; this.timeAdjustmentMinutes = timeAdjustmentMinutes;
        this.paidAbsenceMinutes = paidAbsenceMinutes; this.payableMinutes = payableMinutes;
        this.basePayMinor = basePayMinor; this.additionsMinor = additionsMinor; this.deductionsMinor = deductionsMinor;
        this.totalPayMinor = totalPayMinor; this.sourcePeriodClosedAt = sourcePeriodClosedAt;
        this.sourceIntegrityCheckedAt = sourceIntegrityCheckedAt; this.calculationHash = calculationHash;
    }
    ...
    public long getBasePayMinor() { return basePayMinor; } public long getAdditionsMinor() { return additionsMinor; }
