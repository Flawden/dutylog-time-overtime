...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.24.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.24.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.24.1."
...
contains docs/ROADMAP.md "Current release: **v27.24.1 — Calendar Comfort E2E Panel Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.24.1 — Calendar Comfort E2E Panel Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.24.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.24.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.24.1"
...
contains src/test/java/ru/daniil/shifts/web/ImportantDatesTimezoneOvertimeFrontendContractTest.java "let timeSettingsApplyQueue = Promise.resolve();"
  ...
  ok "Playwright test baseline: 33"
else
  fail "expected 33 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "569" ]]; then
  ok "test method baseline: 569"
else
  fail "expected 569 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "108" ]]; then
  ok "test class baseline: 108"
else
  fail "expected 108 test classes, found $TEST_CLASSES"
fi
