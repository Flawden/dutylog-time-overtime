...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.42.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.42.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.42.2."
...
contains docs/ROADMAP.md "Current release: **v27.42.2 — People Profiles Source Contract Alignment Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.42.2 — People Profiles Source Contract Alignment Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.42.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.42.2."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.42.2."
contains docs/SECURITY_REVIEW.md "Status: v27.42.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.42.2."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.42.2-'
  ...
  contains frontend/browser-bundle-budget.json '"release": "27.42.2"'
  ...
  contains frontend/generated-lockfile-manifest.txt 'nextAction=shared-availability-after-v27.42.2-green'
  ...
  contains frontend/src/features/calendar-timeline/components/SelectedDayPanel.vue 'сам резервирует и списывает часы банка по FIFO'
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.42.2."
  contains docs/MODULE_CONTRACTS.md "Status: v27.42.2."
  contains docs/SUPPLY_CHAIN.md "Status: v27.42.2."
  contains frontend/generated-lockfile-manifest.txt 'release=27.42.2'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=shared-availability-after-v27.42.2-green'
...
contains CHANGES.md "v27.42.2 — People Profiles Source Contract Alignment Hotfix"
contains README.md "DutyLog v27.42.2 — People Profiles Source Contract Alignment Hotfix"
contains docs/PEOPLE_PROFILES_SOURCE_CONTRACT_ALIGNMENT_HOTFIX_V27.42.2.md "dayPanelOpen && viewingSelf"
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java '<SelectedDayPanel v-if=\"dayPanelOpen && viewingSelf\"'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.42.2."
  contains frontend/generated-lockfile-manifest.txt 'release=27.42.2'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=2cce0a2a8adae7801e9ced0ae16c881d39f40941d862a1b931098d445cb80041'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=shared-availability-after-v27.42.2-green'
...
if [[ "$VITEST_TESTS" == "66" ]]; then
  ok "Vitest case baseline: 66"
else
  fail "expected 66 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "791" ]]; then
  ok "test method baseline: 791"
else
  fail "expected 791 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "163" ]]; then
  ok "test class baseline: 163"
else
  fail "expected 163 test classes, found $TEST_CLASSES"
fi
