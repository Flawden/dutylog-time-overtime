...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.25.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.25.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.25.1."
...
contains docs/ROADMAP.md "Current release: **v27.25.1 — Absence Preview Lambda Compile Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.25.1 — Absence Preview Lambda Compile Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.25.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.25.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.25.1"
...
if [[ "$TEST_METHODS" == "580" ]]; then
  ok "test method baseline: 580"
else
  fail "expected 580 @Test methods, found $TEST_METHODS"
fi
