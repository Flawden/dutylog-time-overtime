...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.12}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.12"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.12."
...
contains docs/ROADMAP.md "Current release: **v27.40.12 — Legacy Command Surface Retirement**"
...
contains docs/ROADMAP.md "Current release: **v27.40.12 — Legacy Command Surface Retirement**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.12"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.12."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.12."
contains docs/SECURITY_REVIEW.md "Status: v27.40.12."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.12."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.12-'
  ...
  contains docs/ROADMAP.md "Current release: **v27.40.12 — Legacy Command Surface Retirement**"
  contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.12"
  contains docs/RELEASE_CHECKLIST.md "v27.40.12 — Legacy Command Surface Retirement acceptance"
  contains frontend/src/platform/bridge/legacyBridge.ts 'type: "navigate"'
  contains frontend/src/platform/bridge/legacyBridge.ts 'type: "logout"'
  ...
  not_contains frontend/src/types/window.d.ts 'openModal('
  not_contains frontend/src/types/window.d.ts 'openTaskCreate?'
  not_contains frontend/src/types/window.d.ts 'openTaskDetails?'
  not_contains frontend/src/types/window.d.ts 'openImportantDetails?'
  not_contains src/main/resources/static/js/10-core.js '  openModal(id'
  not_contains src/main/resources/static/js/10-core.js '  openTaskCreate(date'
  not_contains src/main/resources/static/js/10-core.js '  openTaskDetails(id'
  not_contains src/main/resources/static/js/10-core.js '  openImportantDetails(id'
