...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.36.5}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.36.5"
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.5."
...
contains docs/ROADMAP.md "Current release: **v27.36.5 — Single-Pass CI & Final Vue Browser Parity Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.36.5 — Single-Pass CI & Final Vue Browser Parity Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.36.5"
...
contains docs/SECURITY_REVIEW.md "Status: v27.36.5."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.36.5"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.5."
contains docs/SECURITY_REVIEW.md "Status: v27.36.5."
contains docs/MODULE_CONTRACTS.md "Status: v27.36.5."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.36.5'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.36.5'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.36.5//RU'
...
contains docs/ROADMAP.md "v27.36.5 — Single-Pass CI & Final Vue Browser Parity Hotfix — current"
...
contains frontend/src/features/absence-time-bank/stores/absenceTimeBankStore.ts "if (sequence !== refreshSequence) return;"
...
contains frontend/src/features/absence-time-bank/stores/absenceTimeBankStore.ts 'let refreshSequence = 0'
contains frontend/src/features/absence-time-bank/stores/absenceTimeBankStore.ts 'if (sequence !== refreshSequence) return'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.36.5//RU"
...
not_contains src/main/java/ru/daniil/shifts/module/DutyLogModules.java 'ModuleService.PAYROLL'
  ...
  ok "Playwright test baseline: 45"
else
  fail "expected 45 Playwright tests, found $E2E_TESTS"
fi

VITEST_TESTS=$(grep -R --include='*.spec.ts' -h -E '^[[:space:]]*it\(' frontend/src | wc -l | tr -d ' ')
if [[ "$VITEST_TESTS" == "29" ]]; then
  ok "Vitest case baseline: 29"
else
  fail "expected 29 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "710" ]]; then
  ok "test method baseline: 710"
else
  fail "expected 710 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "146" ]]; then
  ok "test class baseline: 146"
else
  fail "expected 146 test classes, found $TEST_CLASSES"
fi
