...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.39.5}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.39.5"
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.5."
...
contains docs/ROADMAP.md "Current release: **v27.39.5 — Vue Settings State Ownership Browser Parity Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.39.5 — Vue Settings State Ownership Browser Parity Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.39.5"
...
contains docs/SECURITY_REVIEW.md "Status: v27.39.5."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.5."
contains docs/SECURITY_REVIEW.md "Status: v27.39.5."
contains docs/MODULE_CONTRACTS.md "Status: v27.39.5."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains CHANGES.md "v27.39.5 — Vue Settings State Ownership Browser Parity Hotfix"
  contains README.md "DutyLog v27.39.5 — Vue Settings State Ownership Browser Parity Hotfix"
  contains docs/VUE_SETTINGS_STATE_OWNERSHIP_BROWSER_PARITY_HOTFIX_V27.39.5.md "42 passed and 6 failed"
  contains docs/ROADMAP.md "Current release: **v27.39.5 — Vue Settings State Ownership Browser Parity Hotfix**"
  contains docs/RELEASE_CHECKLIST.md "v27.39.5 — Vue Settings State Ownership Browser Parity Hotfix acceptance"
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.39.5-'
