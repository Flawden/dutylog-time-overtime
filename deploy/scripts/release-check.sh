...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.21}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.21"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.21."
...
contains docs/ROADMAP.md "Current release: **v27.40.21 — Vue Payroll Workspace Retirement**"
...
contains docs/ROADMAP.md "Current release: **v27.40.21 — Vue Payroll Workspace Retirement**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.21"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.21."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.21."
contains docs/SECURITY_REVIEW.md "Status: v27.40.21."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.21."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.21-'
  ...
  not_contains e2e/pwa-upgrade.spec.js "dutylog-shell-v27.40.21-"
  ...
  contains src/test/java/ru/daniil/shifts/web/VueRouteGuardAuthorityCutoverTest.java 'postVueLegacyRouterOnlyKeepsAdminSideEffects'
...
if [[ "$TEST_METHODS" == "769" ]]; then
  ok "test method baseline: 769"
else
  fail "expected 769 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "158" ]]; then
  ok "test class baseline: 158"
else
  fail "expected 158 test classes, found $TEST_CLASSES"
fi
