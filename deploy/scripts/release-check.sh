...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.31.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.31.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.31.1."
...
contains docs/ROADMAP.md "Current release: **v27.31.1 — Canonical Absence Static Contract Alignment Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.31.1 — Canonical Absence Static Contract Alignment Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.31.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.31.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.31.1"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.31.1."
contains docs/SECURITY_REVIEW.md "Status: v27.31.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.31.1."
...
contains docs/ROADMAP.md "v27.31.1 — Canonical Absence Static Contract Alignment Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.31.1//RU"
...
if [[ "$TEST_METHODS" == "626" ]]; then
  ok "test method baseline: 626"
else
  fail "expected 626 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "127" ]]; then
  ok "test class baseline: 127"
else
  fail "expected 127 test classes, found $TEST_CLASSES"
fi
