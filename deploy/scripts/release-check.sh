...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.22}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.22"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.22."
...
contains docs/ROADMAP.md "Current release: **v27.40.22 — Vue Admin Workspace & Final Live Legacy UI Retirement**"
...
contains docs/ROADMAP.md "Current release: **v27.40.22 — Vue Admin Workspace & Final Live Legacy UI Retirement**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.22"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.22."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.22."
contains docs/SECURITY_REVIEW.md "Status: v27.40.22."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.22."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.22-'
  ...
  not_contains e2e/pwa-upgrade.spec.js "dutylog-shell-v27.40.22-"
...
if [[ "$TEST_METHODS" == "772" ]]; then
  ok "test method baseline: 772"
else
  fail "expected 772 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "159" ]]; then
  ok "test class baseline: 159"
else
  fail "expected 159 test classes, found $TEST_CLASSES"
fi
