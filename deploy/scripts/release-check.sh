...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.29.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.29.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.1."
...
contains docs/ROADMAP.md "Current release: **v27.29.1 — Theme Package Token Scope Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.29.1 — Theme Package Token Scope Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.29.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.29.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.29.1"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.1."
contains docs/SECURITY_REVIEW.md "Status: v27.29.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.29.1."
...
contains docs/ROADMAP.md "v27.29.1 — Theme Package Token Scope Contract Hotfix — current"
...
if [[ "$TEST_METHODS" == "611" ]]; then
  ok "test method baseline: 611"
else
  fail "expected 611 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "120" ]]; then
  ok "test class baseline: 120"
else
  fail "expected 120 test classes, found $TEST_CLASSES"
fi
