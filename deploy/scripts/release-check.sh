...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.37.5}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.37.5"
contains docs/RELEASE_CHECKLIST.md "Status: v27.37.5."
...
contains docs/ROADMAP.md "Current release: **v27.37.5 — Vue Calendar Selected-Day Island Lifecycle Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.37.5 — Vue Calendar Selected-Day Island Lifecycle Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.37.5"
...
contains docs/SECURITY_REVIEW.md "Status: v27.37.5."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.37.5."
contains docs/SECURITY_REVIEW.md "Status: v27.37.5."
contains docs/MODULE_CONTRACTS.md "Status: v27.37.5."
...
contains frontend/src/generated/dutylog-api.ts 'Contract: 98 operations, 103 schemas'
...
if [[ "$VITEST_TESTS" == "43" ]]; then
  ok "Vitest case baseline: 43"
else
  fail "expected 43 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_CLASSES" == "151" ]]; then
  ...
  fail "expected 151 test classes, found $TEST_CLASSES"
fi
