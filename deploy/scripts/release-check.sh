...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.20.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.20.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.20.0."
...
contains docs/ROADMAP.md "Current release: **v27.20.0 — Notes & Important Events Next**"
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.20.0"
...
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.20.0"
