...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.28.3}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.28.3"
contains docs/RELEASE_CHECKLIST.md "Status: v27.28.3."
...
contains docs/ROADMAP.md "Current release: **v27.28.3 — Payroll Snapshot Hash Schema Validation Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.28.3 — Payroll Snapshot Hash Schema Validation Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.28.3"
...
contains docs/SECURITY_REVIEW.md "Status: v27.28.3."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.28.3"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.28.3."
contains docs/SECURITY_REVIEW.md "Status: v27.28.3."
contains docs/MODULE_CONTRACTS.md "Status: v27.28.3."
...
contains docs/ROADMAP.md "v27.28.3 — Payroll Snapshot Hash Schema Validation Hotfix — current"
...
not_contains src/main/java/ru/daniil/shifts/module/DutyLogModules.java 'ModuleService.PAYROLL'
  ...
  ok "Playwright test baseline: 37"
else
  fail "expected 37 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "605" ]]; then
  ok "test method baseline: 605"
else
  fail "expected 605 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "118" ]]; then
  ok "test class baseline: 118"
else
  fail "expected 118 test classes, found $TEST_CLASSES"
fi
