...
if [[ "$TEST_METHODS" == "1068" ]]; then
  ok "test method baseline: 1068"
else
  fail "expected 1068 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "230" ]]; then
  ok "test class baseline: 230"
else
  fail "expected 230 test classes, found $TEST_CLASSES"
fi
