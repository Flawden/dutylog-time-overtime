...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.42.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.42.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.42.1."
...
contains docs/ROADMAP.md "Current release: **v27.42.1 — People Profiles Source Contract Alignment Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.42.1 — People Profiles Source Contract Alignment Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.42.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.42.1."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.42.1."
contains docs/SECURITY_REVIEW.md "Status: v27.42.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.42.1."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.42.1-'
  ...
  contains frontend/browser-bundle-budget.json '"release": "27.42.1"'
  ...
  contains frontend/generated-lockfile-manifest.txt 'nextAction=shared-availability-after-v27.42.1-green'
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.42.1."
  contains docs/MODULE_CONTRACTS.md "Status: v27.42.1."
  contains docs/SUPPLY_CHAIN.md "Status: v27.42.1."
  contains frontend/generated-lockfile-manifest.txt 'release=27.42.1'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=shared-availability-after-v27.42.1-green'
...
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java '<SelectedDayPanel v-if=\"dayPanelOpen && viewingSelf\"'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.42.1."
  contains frontend/generated-lockfile-manifest.txt 'release=27.42.1'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=07577ac363561feb3860189faf03519ad1c640fd8f8d1db6a1807b8fd3514aa6'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=shared-availability-after-v27.42.1-green'
