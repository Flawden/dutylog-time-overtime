...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.34.4}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.34.4"
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.4."
...
contains docs/ROADMAP.md "Current release: **v27.34.4 — Vue Secondary Navigation & Overtime Preview Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.34.4 — Vue Secondary Navigation & Overtime Preview Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.34.4"
...
contains docs/SECURITY_REVIEW.md "Status: v27.34.4."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.34.4"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.4."
contains docs/SECURITY_REVIEW.md "Status: v27.34.4."
contains docs/MODULE_CONTRACTS.md "Status: v27.34.4."
...
contains Dockerfile 'FROM node:20-alpine AS frontend-build'
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.34.4'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.34.4'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.34.4//RU'
...
contains docs/ROADMAP.md "v27.34.4 — Vue Secondary Navigation & Overtime Preview Contract Hotfix — current"
...
contains frontend/src/app/AppNavigation.vue ":aria-current=\"secondaryActive ? 'page' : false\""
contains frontend/src/app/AppShell.vue ":aria-current=\"activeRoute === item.route ? 'page' : false\""
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.34.4//RU"
...
if [[ "$VITEST_TESTS" == "11" ]]; then
  ok "Vitest case baseline: 11"
else
  fail "expected 11 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "652" ]]; then
  ok "test method baseline: 652"
else
  fail "expected 652 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "136" ]]; then
  ok "test class baseline: 136"
else
  fail "expected 136 test classes, found $TEST_CLASSES"
fi
