...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.25.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.25.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.25.2."
...
contains docs/ROADMAP.md "Current release: **v27.25.2 — Absence Experience Frontend Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.25.2 — Absence Experience Frontend Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.25.2"
...
contains deploy/scripts/check-production-env.sh 'production nginx suppresses access logs for calendar bearer URLs'
  ...
  contains CHANGES.md "v27.22.2 — Workspace-Aware Tasks E2E Navigation Hotfix"
  contains README.md "v27.22.2 — Workspace-Aware Tasks E2E Navigation Hotfix"
  contains docs/WORKSPACE_AWARE_TASKS_E2E_HOTFIX_V27.22.2.md "workspaceHidden"
...
contains docs/SECURITY_REVIEW.md "Status: v27.25.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.25.2"
...
contains src/main/resources/static/index.html 'id="overtimeUsageModal"'
...
contains src/main/resources/static/js/40-overtime.js "updateUsageBalancePreview"
...
contains src/main/java/ru/daniil/shifts/service/VacationPlannerService.java 'TIME_OFF_LIMIT_EXCEEDED'
...
contains src/main/resources/static/js/39-vacation-planner.js 'coverage:partial ? "PARTIAL" : "FULL_DAY"'
...
contains e2e/important-timezone.spec.js "03.07 23:00–04.07 07:00"
contains e2e/important-timezone.spec.js "2026-07-03"
...
contains src/test/java/ru/daniil/shifts/web/ImportantDatesTimezoneOvertimeFrontendContractTest.java "let timeSettingsApplyQueue = Promise.resolve();"
  ...
  ok "Playwright test baseline: 34"
else
  fail "expected 34 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "581" ]]; then
  ok "test method baseline: 581"
else
  fail "expected 581 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "109" ]]; then
  ok "test class baseline: 109"
else
  fail "expected 109 test classes, found $TEST_CLASSES"
fi
