...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.39.6}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.39.6"
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.6."
...
contains docs/ROADMAP.md "Current release: **v27.39.6 — Module Runtime Synchronization & Offline Reconnect Ownership Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.39.6 — Module Runtime Synchronization & Offline Reconnect Ownership Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.39.6"
...
contains docs/SECURITY_REVIEW.md "Status: v27.39.6."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.6."
contains docs/SECURITY_REVIEW.md "Status: v27.39.6."
contains docs/MODULE_CONTRACTS.md "Status: v27.39.6."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains CHANGES.md "v27.39.6 — Module Runtime Synchronization & Offline Reconnect Ownership Hotfix"
  contains README.md "DutyLog v27.39.6 — Module Runtime Synchronization & Offline Reconnect Ownership Hotfix"
  contains docs/VUE_SETTINGS_MODULE_RUNTIME_SYNC_PWA_RECONNECT_HOTFIX_V27.39.6.md "44 passed and 4 failed"
  contains docs/ROADMAP.md "Current release: **v27.39.6 — Module Runtime Synchronization & Offline Reconnect Ownership Hotfix**"
  contains docs/RELEASE_CHECKLIST.md "v27.39.6 — Module Runtime Synchronization & Offline Reconnect Ownership Hotfix acceptance"
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.39.6-'
