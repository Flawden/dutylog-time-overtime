...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.28.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.28.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.28.1."
...
contains docs/ROADMAP.md "Current release: **v27.28.1 — Payroll Module Registry Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.28.1 — Payroll Module Registry Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.28.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.28.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.28.1"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.28.1."
contains docs/SECURITY_REVIEW.md "Status: v27.28.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.28.1."
...
contains docs/ROADMAP.md "v27.28.1 — Payroll Module Registry Contract Hotfix — current"
...
if [[ "$TEST_METHODS" == "603" ]]; then
  ok "test method baseline: 603"
else
  fail "expected 603 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "116" ]]; then
  ok "test class baseline: 116"
else
  fail "expected 116 test classes, found $TEST_CLASSES"
fi
