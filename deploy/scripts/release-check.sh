...
VERSION="${DUTYLOG_RELEASE_VERSION:-26.6.10}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
  "js/20-data.js"
...
contains docs/SECURITY_REVIEW.md "v26.6.10"
contains docs/TEST_CONFIG_HOTFIX.md "v26.6.10"
contains .github/workflows/ci.yml "bash ./deploy/scripts/release-check.sh"
contains docs/CI_PERMISSION_HOTFIX.md "v26.6.10"
...
contains docs/ONBOARDING_TODAY_HOTFIX.md "v26.6.10"
contains docs/DAY_HINT_DISMISS_HOTFIX.md "v26.6.10"
contains docs/I18N_POLISH_HOTFIX.md "v26.6.10"
contains docs/LOGIN_LANGUAGE_HOTFIX.md "v26.6.10"
