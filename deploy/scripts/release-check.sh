...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.39.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.39.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.2."
...
contains docs/ROADMAP.md "Current release: **v27.39.2 — Vue Settings Maven Contract Alignment Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.39.2 — Vue Settings Maven Contract Alignment Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.39.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.39.2."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.2."
contains docs/SECURITY_REVIEW.md "Status: v27.39.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.39.2."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.39.2-'
