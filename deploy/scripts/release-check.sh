...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.23.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.23.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.23.1."
...
contains docs/ROADMAP.md "Current release: **v27.23.1 — Calendar Sync JSON UTF-8 Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.23.1 — Calendar Sync JSON UTF-8 Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.23.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.23.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.23.1"
...
if [[ "$TEST_METHODS" == "563" ]]; then
  ok "test method baseline: 563"
else
  fail "expected 563 @Test methods, found $TEST_METHODS"
fi
