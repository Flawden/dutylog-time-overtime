...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.30.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.30.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.30.0."
...
contains docs/ROADMAP.md "Current release: **v27.30.0 — Unified Absence Composer & Calendar Projection**"
...
contains docs/ROADMAP.md "Current release: **v27.30.0 — Unified Absence Composer & Calendar Projection**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.30.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.30.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.30.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.30.0."
contains docs/SECURITY_REVIEW.md "Status: v27.30.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.30.0."
...
contains docs/ROADMAP.md "v27.30.0 — Unified Absence Composer & Calendar Projection — current"
...
not_contains src/main/java/ru/daniil/shifts/module/DutyLogModules.java 'ModuleService.PAYROLL'
  ...
  ok "Playwright test baseline: 39"
else
  fail "expected 39 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "616" ]]; then
  ok "test method baseline: 616"
else
  fail "expected 616 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "123" ]]; then
  ok "test class baseline: 123"
else
  fail "expected 123 test classes, found $TEST_CLASSES"
fi
