...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.27.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.27.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.27.0."
...
contains docs/ROADMAP.md "Current release: **v27.27.0 — Ledger Integrity & Approval Workflow**"
...
contains docs/ROADMAP.md "Current release: **v27.27.0 — Ledger Integrity & Approval Workflow**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.27.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.27.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.27.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.27.0."
contains docs/SECURITY_REVIEW.md "Status: v27.27.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.27.0."
...
contains docs/ROADMAP.md "v27.27.0 — Ledger Integrity & Approval Workflow — current"
...
contains src/test/java/ru/daniil/shifts/web/ImportantDatesTimezoneOvertimeFrontendContractTest.java "let timeSettingsApplyQueue = Promise.resolve();"
  ...
  ok "Playwright test baseline: 36"
else
  fail "expected 36 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "598" ]]; then
  ok "test method baseline: 598"
else
  fail "expected 598 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "112" ]]; then
  ok "test class baseline: 112"
else
  fail "expected 112 test classes, found $TEST_CLASSES"
fi
