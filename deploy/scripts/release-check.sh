...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.45.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/SECURITY_REVIEW.md "Status: v27.45.1."
...
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java '<SelectedDayPanel v-if=\"dayPanelOpen && viewingSelf\"'
  ...
  contains docs/API.md "130 operations / 136 schemas"
  contains frontend/src/generated/dutylog-api.ts 'Contract: 130 operations, 136 schemas'
