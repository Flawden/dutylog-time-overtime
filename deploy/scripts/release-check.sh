...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.35.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.35.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.35.2."
...
contains docs/ROADMAP.md "Current release: **v27.35.2 — Authentic npm Lockfile Bootstrap Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.35.2 — Authentic npm Lockfile Bootstrap Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.35.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.35.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.35.2"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.35.2."
contains docs/SECURITY_REVIEW.md "Status: v27.35.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.35.2."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.35.2'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.35.2'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.35.2//RU'
...
contains docs/ENGINEERING_QUALITY_REGISTER.md 'Gate A остаётся закрыт для `v27.36.0`'
...
contains Dockerfile 'npm install --package-lock-only --ignore-scripts'
not_contains Dockerfile 'npx '

  # v27.35.2 Authentic npm Lockfile Bootstrap Hotfix
contains .gitignore 'frontend/package-lock.json'
...
contains docs/ROADMAP.md "v27.35.2 — Authentic npm Lockfile Bootstrap Hotfix — current"
...
contains deploy/scripts/bootstrap-frontend-lockfile.sh 'install --package-lock-only --ignore-scripts'
contains frontend/scripts/verify-authentic-lockfile.mjs 'integrityEntries.length < 70'
contains .github/workflows/ci.yml 'Upload generated authentic frontend lockfile'
contains .github/workflows/deploy-staging.yml 'frontend/generated-lockfile-manifest.txt'
...
contains src/test/java/ru/daniil/shifts/web/AuthenticNpmLockfileBootstrapHotfixTest.java 'class AuthenticNpmLockfileBootstrapHotfixTest'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.35.2//RU"
...
if [[ "$TEST_METHODS" == "669" ]]; then
  ok "test method baseline: 669"
else
  fail "expected 669 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "139" ]]; then
  ok "test class baseline: 139"
else
  fail "expected 139 test classes, found $TEST_CLASSES"
fi
