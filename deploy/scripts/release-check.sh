...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.35.3}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.35.3"
contains docs/RELEASE_CHECKLIST.md "Status: v27.35.3."
...
contains docs/ROADMAP.md "Current release: **v27.35.3 — Authentic Lockfile Commit & Generated Client Fixture Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.35.3 — Authentic Lockfile Commit & Generated Client Fixture Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.35.3"
...
contains docs/SECURITY_REVIEW.md "Status: v27.35.3."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.35.3"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.35.3."
contains docs/SECURITY_REVIEW.md "Status: v27.35.3."
contains docs/MODULE_CONTRACTS.md "Status: v27.35.3."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.35.3'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.35.3'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.35.3//RU'
...
contains docs/ROADMAP.md "v27.35.3 — Authentic Lockfile Commit & Generated Client Fixture Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.35.3//RU"
...
if [[ "$TEST_METHODS" == "673" ]]; then
  ok "test method baseline: 673"
else
  fail "expected 673 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "140" ]]; then
  ok "test class baseline: 140"
else
  fail "expected 140 test classes, found $TEST_CLASSES"
fi
