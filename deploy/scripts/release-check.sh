...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.36.8}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.36.8"
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.8."
...
contains docs/ROADMAP.md "Current release: **v27.36.8 — Vue Read Sequencing Static Contract Alignment Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.36.8 — Vue Read Sequencing Static Contract Alignment Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.36.8"
...
contains docs/SECURITY_REVIEW.md "Status: v27.36.8."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.36.8"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.8."
contains docs/SECURITY_REVIEW.md "Status: v27.36.8."
contains docs/MODULE_CONTRACTS.md "Status: v27.36.8."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.36.8'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.36.8'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.36.8//RU'
...
contains docs/ROADMAP.md "v27.36.8 — Vue Read Sequencing Static Contract Alignment Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.36.8//RU"
...
if [[ "$VITEST_TESTS" == "33" ]]; then
  ok "Vitest case baseline: 33"
else
  fail "expected 33 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "727" ]]; then
  ok "test method baseline: 727"
else
  fail "expected 727 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "149" ]]; then
  ok "test class baseline: 149"
else
  fail "expected 149 test classes, found $TEST_CLASSES"
fi
