...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.30}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.30"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.30."
...
contains docs/ROADMAP.md "Current release: **v27.40.30 — Legacy Retirement Closure & First-Run Onboarding Boundary**"
...
contains docs/ROADMAP.md "Current release: **v27.40.30 — Legacy Retirement Closure & First-Run Onboarding Boundary**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.30"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.30."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.30."
contains docs/SECURITY_REVIEW.md "Status: v27.40.30."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.30."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.30-'
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.40.30."
  contains docs/MODULE_CONTRACTS.md "Status: v27.40.30."
  contains docs/SUPPLY_CHAIN.md "Status: v27.40.30."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.30'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=functional-parity-sweep-from-proven-green-v27.40.30'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.40.30."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.30'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=16b7db8036bcc2fe62bc66d34cca3d6685ab380853cb40dbb4e42f3b33fd2988'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=functional-parity-sweep-from-proven-green-v27.40.30'
...
if [[ "$TEST_METHODS" == "785" ]]; then
  ok "test method baseline: 785"
else
  fail "expected 785 @Test methods, found $TEST_METHODS"
fi
