...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.18}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.18"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.18."
...
contains docs/ROADMAP.md "Current release: **v27.40.18 — Calendar ICS Release Version Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.40.18 — Calendar ICS Release Version Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.18"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.18."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.18."
contains docs/SECURITY_REVIEW.md "Status: v27.40.18."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.18."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.18-'
  ...
  contains src/main/java/ru/daniil/shifts/service/CalendarIcsService.java 'PRODID:-//DutyLog//Time and Overtime 27.40.18//RU'
...
if [[ "$TEST_METHODS" == "767" ]]; then
  ok "test method baseline: 767"
else
  fail "expected 767 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "157" ]]; then
  ok "test class baseline: 157"
else
  fail "expected 157 test classes, found $TEST_CLASSES"
fi
