...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.39.4}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.39.4"
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.4."
...
contains docs/ROADMAP.md "Current release: **v27.39.4 — Vue Settings Browser Ownership & Preview Correlation Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.39.4 — Vue Settings Browser Ownership & Preview Correlation Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.39.4"
...
dynamic = {'bdayBanner', 'headerAvatar', 'dayModulesSettingsBtn', 'settingsLegacyParking'}
...
contains docs/SECURITY_REVIEW.md "Status: v27.39.4."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.39.4."
contains docs/SECURITY_REVIEW.md "Status: v27.39.4."
contains docs/MODULE_CONTRACTS.md "Status: v27.39.4."
...
contains e2e/helpers.js "platform.navigateLegacy(target)"
...
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineStrictTypecheckHotfixTest.java "workspaceBridgeCallbackCarriesExplicitGeneratedDomainTypes"
  ...
  contains frontend/src/features/settings-workspace/components/SettingsWorkspace.vue 'id="settingsLegacyHost"'
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains CHANGES.md "v27.39.4 — Vue Settings Browser Ownership & Preview Correlation Hotfix"
  contains README.md "DutyLog v27.39.4 — Vue Settings Browser Ownership & Preview Correlation Hotfix"
  contains docs/VUE_SETTINGS_BROWSER_OWNERSHIP_PREVIEW_CORRELATION_HOTFIX_V27.39.4.md "31 pass and 17 fail"
  contains docs/ROADMAP.md "Current release: **v27.39.4 — Vue Settings Browser Ownership & Preview Correlation Hotfix**"
  contains docs/RELEASE_CHECKLIST.md "v27.39.4 — Vue Settings Browser Ownership & Preview Correlation Hotfix acceptance"
  contains e2e/helpers.js "settings: '[data-vue-settings-workspace-view]'"
  contains e2e/helpers.js "if (view === 'settings') await waitForSettingsWorkspaceReady(page)"
  contains e2e/helpers.js "document.documentElement.dataset.vueSettingsWorkspace === 'ready'"
  contains e2e/absence-time-off-overhaul.spec.js "response.request().postDataJSON()"
  contains e2e/absence-time-off-overhaul.spec.js "request.coverage === 'PARTIAL'"
  contains e2e/absence-time-off-overhaul.spec.js "request.startTime === '09:00'"
  contains e2e/absence-time-off-overhaul.spec.js "request.endTime === '13:00'"
  contains e2e/absence-time-off-overhaul.spec.js "request.compensationPolicy === 'OVERTIME_BANK'"
  contains e2e/absence-time-off-overhaul.spec.js "expect(preview.durationMinutes).toBe(240)"
  contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java "waitForSettingsWorkspaceReady(page)"
  contains src/test/java/ru/daniil/shifts/web/LedgerWorkflowBrowserContractHotfixTest.java "request.endTime === '13:00'"
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.39.4-'
  ...
  contains frontend/src/features/productivity/components/ProductivityWorkspace.vue 'props.bridge.openCalendarSection("notes")'
  ...
  contains src/main/resources/static/js/10-core.js 'openCalendarSection(section)'
...
contains frontend/src/features/productivity/components/ProductivityWorkspace.vue 'window.addEventListener("online", reconnect)'
...
contains frontend/src/types/window.d.ts 'parkCalendarEditor?(): void;'
contains frontend/src/platform/bridge/legacyBridge.ts 'parkCalendarEditor(): void;'
contains frontend/src/platform/bridge/legacyBridge.ts 'parkCalendarEditor() { adapter()?.parkCalendarEditor?.(); }'
contains frontend/src/features/calendar-timeline/components/CalendarPage.vue 'onBeforeUnmount(() => {'
contains frontend/src/features/calendar-timeline/components/CalendarPage.vue 'props.bridge.parkCalendarEditor();'
contains src/main/resources/static/js/10-core.js 'parkCalendarEditor(){'
contains src/main/resources/static/js/10-core.js 'panel.parentElement !== document.body'
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java 'page.contains("props.bridge.parkCalendarEditor()")'
...
contains src/main/resources/static/js/30-calendar.js '$("layout")?.classList.toggle("with-panel", !!k);'
not_contains src/main/resources/static/js/30-calendar.js '$("layout").classList.toggle("with-panel", !!k);'
contains src/main/resources/static/js/30-calendar.js '$("panel").hidden = !k;'
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java 'calendar.contains("$(\"layout\")?.classList.toggle(\"with-panel\", !!k);")'
...
contains e2e/vue-calendar-timeline-migration.spec.js "#calendarLegacyPanelHost > #panel"
...
contains frontend/src/features/absence-time-bank/components/AbsenceTimeBankWorkspace.vue 'if (options?.source === "vacation") props.bridge.navigate("vacation");'
contains frontend/src/features/absence-time-bank/components/AbsenceTimeBankWorkspace.vue 'if (options?.source === "time-bank") props.bridge.navigate("overtime");'
...
if [[ "$VITEST_TESTS" == "52" ]]; then
  ok "Vitest case baseline: 52"
else
  fail "expected 52 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "758" ]]; then
  ok "test method baseline: 758"
else
  fail "expected 758 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "153" ]]; then
  ok "test class baseline: 153"
else
  fail "expected 153 test classes, found $TEST_CLASSES"
fi
