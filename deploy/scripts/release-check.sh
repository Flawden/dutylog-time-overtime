...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.37.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.37.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.37.2."
...
contains docs/ROADMAP.md "Current release: **v27.37.2 — Vue Calendar Boot Routing Null-Safety Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.37.2 — Vue Calendar Boot Routing Null-Safety Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.37.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.37.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.37.2"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.37.2."
contains docs/SECURITY_REVIEW.md "Status: v27.37.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.37.2."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.37.2'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.37.2'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.37.2//RU'
...
not_contains src/test/java/ru/daniil/shifts/web/AuthenticLockfileCommitGeneratedClientFixtureHotfixTest.java 'gate.contains("npm --prefix "$FRONTEND_DIR" ci")'
  ...
  # v27.37.1 Vue Calendar & Timeline Strict Typecheck Hotfix historical contracts
...
contains docs/ROADMAP.md "## v27.37.1 — Vue Calendar & Timeline Strict Typecheck Hotfix — predecessor"
contains docs/REGRESSION_TEST_BASELINE.md "## v27.37.1 Vue Calendar & Timeline Strict Typecheck Hotfix extension"
...
contains docs/migration/calendar-timeline-vue-migration-manifest.md 'follow_up_release: "v27.37.2"'
contains docs/ROADMAP.md "Current release: **v27.37.2 — Vue Calendar Boot Routing Null-Safety Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.37.2"
...
contains e2e/pwa-upgrade.spec.js "dutylog-shell-v27.37.2-"
contains src/main/resources/static/service-worker.js 'k.startsWith("dutylog-shell-")'
contains frontend/browser-bundle-budget.json '"release": "27.37.2"'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.37.2//RU"
