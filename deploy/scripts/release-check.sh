...
if [[ "$TEST_METHODS" == "1080" ]]; then
  ok "test method baseline: 1080"
else
  fail "expected 1080 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "232" ]]; then
  ok "test class baseline: 232"
else
  fail "expected 232 test classes, found $TEST_CLASSES"
fi
