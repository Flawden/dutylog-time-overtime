...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.31}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.31"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.31."
...
contains docs/ROADMAP.md "Current release: **v27.40.31 — Functional Parity Sweep I**"
...
contains docs/ROADMAP.md "Current release: **v27.40.31 — Functional Parity Sweep I**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.31"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.31."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.31."
contains docs/SECURITY_REVIEW.md "Status: v27.40.31."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.31."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.31-'
  ...
  contains CHANGES.md "v27.40.31 — Functional Parity Sweep I"
  contains README.md "DutyLog v27.40.31 — Functional Parity Sweep I"
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.40.31."
  contains docs/MODULE_CONTRACTS.md "Status: v27.40.31."
  contains docs/SUPPLY_CHAIN.md "Status: v27.40.31."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.31'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=functional-parity-sweep-II-after-v27.40.31'
  ...
  contains docs/ROADMAP.md 'v27.40.31 — Functional Parity Sweep I'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.40.31."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.31'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=044ef3b0c6e430617b7ab0dbe7e56f195fc534cc54bdd67e54737413f228efa7'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=functional-parity-sweep-II-after-v27.40.31'
...
if [[ "$VITEST_TESTS" == "62" ]]; then
  ok "Vitest case baseline: 62"
else
  fail "expected 62 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "786" ]]; then
  ok "test method baseline: 786"
else
  fail "expected 786 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "162" ]]; then
  ok "test class baseline: 162"
else
  fail "expected 162 test classes, found $TEST_CLASSES"
fi
