...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.37.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.37.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.37.0."
...
contains docs/ROADMAP.md "Current release: **v27.37.0 — Vue Calendar & Timeline**"
...
contains docs/ROADMAP.md "Current release: **v27.37.0 — Vue Calendar & Timeline**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.37.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.37.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.37.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.37.0."
contains docs/SECURITY_REVIEW.md "Status: v27.37.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.37.0."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.37.0'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.37.0'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.37.0//RU'
...
contains docs/ROADMAP.md "v27.37.0 — Vue Calendar & Timeline — current"
...
contains e2e/pwa-upgrade.spec.js "dutylog-shell-v27.37.0-"
contains src/main/resources/static/service-worker.js 'k.startsWith("dutylog-shell-")'
contains frontend/browser-bundle-budget.json '"release": "27.37.0"'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.37.0//RU"
...
if [[ "$TEST_METHODS" == "738" ]]; then
  ok "test method baseline: 738"
else
  fail "expected 738 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "150" ]]; then
  ok "test class baseline: 150"
else
  fail "expected 150 test classes, found $TEST_CLASSES"
fi
