...
if [[ "$TEST_METHODS" == "1347" ]]; then
  ok "test method baseline: 1347"
else
  fail "expected 1347 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "264" ]]; then
  ok "test class baseline: 264"
else
  fail "expected 264 test classes, found $TEST_CLASSES"
fi
