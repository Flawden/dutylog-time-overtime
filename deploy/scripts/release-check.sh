...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.35.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.35.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.35.0."
...
contains docs/ROADMAP.md "Current release: **v27.35.0 — Vue Delivery, Contracts & Diagnostics Foundation**"
...
contains docs/ROADMAP.md "Current release: **v27.35.0 — Vue Delivery, Contracts & Diagnostics Foundation**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.35.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.35.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.35.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.35.0."
contains docs/SECURITY_REVIEW.md "Status: v27.35.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.35.0."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.35.0'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.35.0'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.35.0//RU'
...
contains docs/ROADMAP.md "v27.35.0 — Vue Delivery, Contracts & Diagnostics Foundation — current"
contains docs/REGRESSION_TEST_BASELINE.md "v27.35.0 Vue Delivery, Contracts & Diagnostics Foundation extension"
contains docs/MODULE_CONTRACTS.md "Vue delivery, generated API and diagnostics (v27.35.0)"
contains docs/SECURITY_REVIEW.md "v27.35.0 delivery, contract and diagnostics review"
...
contains docs/ENGINEERING_QUALITY_REGISTER.md 'Gate A открыт для `v27.36.0`'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.35.0//RU"
...
if [[ "$TEST_METHODS" == "661" ]]; then
  ok "test method baseline: 661"
else
  fail "expected 661 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "137" ]]; then
  ok "test class baseline: 137"
else
  fail "expected 137 test classes, found $TEST_CLASSES"
fi
