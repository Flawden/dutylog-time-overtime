...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.34.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.34.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.1."
...
contains docs/ROADMAP.md "Current release: **v27.34.1 — Vue Strict Type Contract Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.34.1 — Vue Strict Type Contract Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.34.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.34.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.34.1"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.1."
contains docs/SECURITY_REVIEW.md "Status: v27.34.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.34.1."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.34.1'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.34.1'
...
contains docs/ROADMAP.md "v27.34.1 — Vue Strict Type Contract Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.34.1//RU"
...
if [[ "$TEST_METHODS" == "646" ]]; then
  ok "test method baseline: 646"
else
  fail "expected 646 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "133" ]]; then
  ok "test class baseline: 133"
else
  fail "expected 133 test classes, found $TEST_CLASSES"
fi
