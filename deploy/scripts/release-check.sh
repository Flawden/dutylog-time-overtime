...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.25.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.25.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.25.0."
...
contains docs/ROADMAP.md "Current release: **v27.25.0 — Absence & Time-Off Overhaul**"
...
contains docs/ROADMAP.md "Current release: **v27.25.0 — Absence & Time-Off Overhaul**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.25.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.25.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.25.0"
...
if [[ "$TEST_METHODS" == "579" ]]; then
  ok "test method baseline: 579"
else
  fail "expected 579 @Test methods, found $TEST_METHODS"
fi
