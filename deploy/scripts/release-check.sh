...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.44.3}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.44.3"
contains docs/RELEASE_CHECKLIST.md "Status: v27.44.3."
...
contains docs/ROADMAP.md "Current release: **v27.44.3 — People Profile Coverage Semantics Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.44.3 — People Profile Coverage Semantics Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.44.3"
...
contains docs/SECURITY_REVIEW.md "Status: v27.44.3."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.44.3."
contains docs/SECURITY_REVIEW.md "Status: v27.44.3."
contains docs/MODULE_CONTRACTS.md "Status: v27.44.3."
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.44.3."
  contains docs/MODULE_CONTRACTS.md "Status: v27.44.3."
  contains docs/SUPPLY_CHAIN.md "Status: v27.44.3."
...
if [[ "$VITEST_TESTS" == "72" ]]; then
  ok "Vitest case baseline: 72"
else
  fail "expected 72 Vitest cases, found $VITEST_TESTS"
fi
