...
if [[ "$TEST_METHODS" == "1072" ]]; then
  ok "test method baseline: 1072"
else
  fail "expected 1072 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "231" ]]; then
  ok "test class baseline: 231"
else
  fail "expected 231 test classes, found $TEST_CLASSES"
fi
