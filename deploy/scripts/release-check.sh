...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.32.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.32.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.32.1."
...
contains docs/ROADMAP.md "Current release: **v27.32.1 — Time Bank Absence Navigation Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.32.1 — Time Bank Absence Navigation Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.32.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.32.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.32.1"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.32.1."
contains docs/SECURITY_REVIEW.md "Status: v27.32.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.32.1."
...
contains docs/ROADMAP.md "v27.32.1 — Time Bank Absence Navigation Hotfix — current"
...
contains src/main/resources/static/js/39-vacation-planner.js 'async function openAbsenceEditor(id, { source = "vacation" } = {})'
contains src/main/resources/static/js/39-vacation-planner.js 'editAbsence(period.id, { navigate:false, scroll:false })'
contains src/main/resources/static/js/39-vacation-planner.js 'openAppModal("absenceComposerModal", "vacationTitle")'
contains src/main/resources/static/js/39-vacation-planner.js 'await previewVacationDraft()'
contains src/main/resources/static/js/40-overtime.js 'return await openAbsenceEditor(Number(usage.sourceAbsenceId), { source:"time-bank" })'
not_contains src/main/resources/static/js/40-overtime.js 'editAbsence(Number(usage.sourceAbsenceId))'
contains src/test/java/ru/daniil/shifts/web/AbsenceTimeBankNavigationHotfixTest.java 'bankUsageOpensTheOwningAbsenceInTheComposerInsteadOfOnlyRoutingToVacation'
contains src/test/java/ru/daniil/shifts/web/AbsenceTimeBankNavigationHotfixTest.java 'composerRefreshesMissingAbsenceDataAndBuildsTheLinkedFifoPreview'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.32.1//RU"
...
if [[ "$TEST_METHODS" == "635" ]]; then
  ok "test method baseline: 635"
else
  fail "expected 635 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "130" ]]; then
  ok "test class baseline: 130"
else
  fail "expected 130 test classes, found $TEST_CLASSES"
fi
