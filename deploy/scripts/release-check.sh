...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.22.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.22.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.22.2."
...
contains docs/ROADMAP.md "Current release: **v27.22.2 — Workspace Route E2E Navigation Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.22.2 — Workspace Route E2E Navigation Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.22.2"
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.22.2"
