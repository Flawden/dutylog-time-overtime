...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.41.5}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.41.5"
contains docs/RELEASE_CHECKLIST.md "Status: v27.41.5."
...
contains docs/ROADMAP.md "Current release: **v27.41.5 — Browser Bundle Budget Rebaseline Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.41.5 — Browser Bundle Budget Rebaseline Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.41.5"
...
contains docs/SECURITY_REVIEW.md "Status: v27.41.5."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.41.5."
contains docs/SECURITY_REVIEW.md "Status: v27.41.5."
contains docs/MODULE_CONTRACTS.md "Status: v27.41.5."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.41.5-'
  ...
  contains frontend/browser-bundle-budget.json '"release": "27.41.5"'
  ...
  contains frontend/generated-lockfile-manifest.txt 'nextAction=frontend-bundle-segmentation-after-v27.41.5-green'
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.41.5."
  contains docs/MODULE_CONTRACTS.md "Status: v27.41.5."
  contains docs/SUPPLY_CHAIN.md "Status: v27.41.5."
  contains frontend/generated-lockfile-manifest.txt 'release=27.41.5'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=frontend-bundle-segmentation-after-v27.41.5-green'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.41.5."
  contains frontend/generated-lockfile-manifest.txt 'release=27.41.5'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=306eef4bd1b77c4e3ca6e7542c126c4dc9f8f0a096927db0a3bc08398ed0ec76'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=frontend-bundle-segmentation-after-v27.41.5-green'
...
if [[ "$TEST_METHODS" == "790" ]]; then
  ok "test method baseline: 790"
else
  fail "expected 790 @Test methods, found $TEST_METHODS"
fi
