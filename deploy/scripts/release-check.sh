...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.38.11}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.38.11"
contains docs/RELEASE_CHECKLIST.md "Status: v27.38.11."
...
contains docs/ROADMAP.md "Current release: **v27.38.11 — Vue Read-Your-Write & PWA Activation Browser Parity Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.38.11 — Vue Read-Your-Write & PWA Activation Browser Parity Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.38.11"
...
contains docs/SECURITY_REVIEW.md "Status: v27.38.11."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.38.11."
contains docs/SECURITY_REVIEW.md "Status: v27.38.11."
contains docs/MODULE_CONTRACTS.md "Status: v27.38.11."
...
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineStrictTypecheckHotfixTest.java "workspaceBridgeCallbackCarriesExplicitGeneratedDomainTypes"
  ...
  contains e2e/pwa-upgrade.spec.js 'v27.38.11 shell'
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.38.11-'
  ...
  contains docs/ROADMAP.md "v27.41.0 — Payroll Calculation Engine"
