...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.44.4}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.44.4"
contains docs/RELEASE_CHECKLIST.md "Status: v27.44.4."
...
contains docs/ROADMAP.md "Current release: **v27.44.4 — Shared Full-Day Free Dates**"
...
contains docs/ROADMAP.md "Current release: **v27.44.4 — Shared Full-Day Free Dates**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.44.4"
...
contains docs/SECURITY_REVIEW.md "Status: v27.44.4."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.44.4."
contains docs/SECURITY_REVIEW.md "Status: v27.44.4."
contains docs/MODULE_CONTRACTS.md "Status: v27.44.4."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains frontend/generated-lockfile-manifest.txt "nextAction=production-calendar-foundation-after-v${VERSION}-green"
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.44.4."
  contains docs/MODULE_CONTRACTS.md "Status: v27.44.4."
  contains docs/SUPPLY_CHAIN.md "Status: v27.44.4."
...
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java '<SelectedDayPanel v-if=\"dayPanelOpen && viewingSelf\"'
  ...
  contains docs/API.md "126 operations / 132 schemas"
  contains frontend/src/generated/dutylog-api.ts 'Contract: 126 operations, 132 schemas'
