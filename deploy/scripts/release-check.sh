...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.16}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.16"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.16."
...
contains docs/ROADMAP.md "Current release: **v27.40.16 — Vue Route-Entry Freshness, Today Workspace & Note Read-Your-Write Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.40.16 — Vue Route-Entry Freshness, Today Workspace & Note Read-Your-Write Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.16"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.16."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.16."
contains docs/SECURITY_REVIEW.md "Status: v27.40.16."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.16."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.16-'
...
if [[ "$VITEST_TESTS" == "57" ]]; then
  ok "Vitest case baseline: 57"
else
  fail "expected 57 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "764" ]]; then
  ok "test method baseline: 764"
else
  fail "expected 764 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "155" ]]; then
  ok "test class baseline: 155"
else
  fail "expected 155 test classes, found $TEST_CLASSES"
fi
