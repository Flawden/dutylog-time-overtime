...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.36.4}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.36.4"
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.4."
...
contains docs/ROADMAP.md "Current release: **v27.36.4 — Vue Absence & Time Bank Browser Parity Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.36.4 — Vue Absence & Time Bank Browser Parity Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.36.4"
...
contains docs/SECURITY_REVIEW.md "Status: v27.36.4."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.36.4"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.4."
contains docs/SECURITY_REVIEW.md "Status: v27.36.4."
contains docs/MODULE_CONTRACTS.md "Status: v27.36.4."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.36.4'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.36.4'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.36.4//RU'
...
contains docs/ROADMAP.md "v27.36.4 — Vue Absence & Time Bank Browser Parity Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.36.4//RU"
...
if [[ "$VITEST_TESTS" == "27" ]]; then
  ok "Vitest case baseline: 27"
else
  fail "expected 27 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "702" ]]; then
  ok "test method baseline: 702"
else
  fail "expected 702 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "145" ]]; then
  ok "test class baseline: 145"
else
  fail "expected 145 test classes, found $TEST_CLASSES"
fi
