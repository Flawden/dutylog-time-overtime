...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.34.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
start_release_matcher() {
  ...
  : > "$RELEASE_CHECK_MATCHER_TMP/requests.tsv"
  exec 9>"$RELEASE_CHECK_MATCHER_TMP/requests.tsv"
}
...
contains docs/API.md "# DutyLog API v27.34.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.0."
...
contains docs/ROADMAP.md "Current release: **v27.34.0 — Vue App Shell & Design System**"
...
contains docs/ROADMAP.md "Current release: **v27.34.0 — Vue App Shell & Design System**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.34.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.34.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.34.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.0."
contains docs/SECURITY_REVIEW.md "Status: v27.34.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.34.0."
...
contains docs/ROADMAP.md "v27.34.0 — Vue App Shell & Design System — current"
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.34.0'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.34.0'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.34.0//RU"
...
if [[ "$TEST_METHODS" == "645" ]]; then
  ok "test method baseline: 645"
else
  fail "expected 645 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "132" ]]; then
  ok "test class baseline: 132"
else
  fail "expected 132 test classes, found $TEST_CLASSES"
fi
