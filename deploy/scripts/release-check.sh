...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.25}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.25"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.25."
...
contains docs/ROADMAP.md "Current release: **v27.40.25 — Vue Offline Sync Surface & Legacy Header Retirement**"
...
contains docs/ROADMAP.md "Current release: **v27.40.25 — Vue Offline Sync Surface & Legacy Header Retirement**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.25"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.25."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.25."
contains docs/SECURITY_REVIEW.md "Status: v27.40.25."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.25."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.25-'
  ...
  contains docs/FRONTEND_ARCHITECTURE.md "First-run onboarding is the only intentionally live post-ready legacy presentation exception in v27.40.25"
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.40.25."
  contains docs/MODULE_CONTRACTS.md "Status: v27.40.25."
  contains docs/SUPPLY_CHAIN.md "Status: v27.40.25."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.25'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=4340ebf5787835c89c3ebf195f869039c4385f3fa12535421277a15dd34e9256'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=vue-offline-sync-surface-legacy-header-retirement-acceptance-for-v27.40.25'
  ...
  contains src/main/resources/static/js/shell-bootstrap.js 'document.querySelector("body > .head")?.remove();'
  ...
  contains src/main/resources/static/index.html '<div class="head">'
  ...
  contains e2e/vue-app-shell.spec.js "page.locator('body > .head')).toHaveCount(0)"
  ...
  contains frontend/src/app/AppShell.vue 'import AdminWorkspace'
  contains frontend/src/app/AppShell.vue '<AdminWorkspace />'
  ...
  not_contains e2e/pwa-upgrade.spec.js "dutylog-shell-v27.40.25-"
...
if [[ "$VITEST_TESTS" == "60" ]]; then
  ok "Vitest case baseline: 60"
else
  fail "expected 60 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "778" ]]; then
  ok "test method baseline: 778"
else
  fail "expected 778 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "161" ]]; then
  ok "test class baseline: 161"
else
  fail "expected 161 test classes, found $TEST_CLASSES"
fi
