...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.26.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.26.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.26.0."
...
contains docs/ROADMAP.md "Current release: **v27.26.0 — Unified Time & Compensation Ledger**"
...
contains docs/ROADMAP.md "Current release: **v27.26.0 — Unified Time & Compensation Ledger**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.26.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.26.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.26.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.26.0."
contains docs/SECURITY_REVIEW.md "Status: v27.26.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.26.0."
...
contains src/test/java/ru/daniil/shifts/web/ImportantDatesTimezoneOvertimeFrontendContractTest.java "let timeSettingsApplyQueue = Promise.resolve();"
  ...
  ok "Playwright test baseline: 35"
else
  fail "expected 35 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "590" ]]; then
  ok "test method baseline: 590"
else
  fail "expected 590 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "110" ]]; then
  ok "test class baseline: 110"
else
  fail "expected 110 test classes, found $TEST_CLASSES"
fi
