...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.44.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.44.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.44.2."
...
contains docs/ROADMAP.md "Current release: **v27.44.2 — Exact Availability Timeline & Shared Shift Summary**"
...
contains docs/ROADMAP.md "Current release: **v27.44.2 — Exact Availability Timeline & Shared Shift Summary**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.44.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.44.2."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.44.2."
contains docs/SECURITY_REVIEW.md "Status: v27.44.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.44.2."
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.44.2."
  contains docs/MODULE_CONTRACTS.md "Status: v27.44.2."
  contains docs/SUPPLY_CHAIN.md "Status: v27.44.2."
...
if [[ "$VITEST_TESTS" == "71" ]]; then
  ok "Vitest case baseline: 71"
else
  fail "expected 71 Vitest cases, found $VITEST_TESTS"
fi
...
contains frontend/browser-bundle-budget.json '"release": "27.44.2"'
