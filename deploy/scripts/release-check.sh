...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.31.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.31.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.31.0."
...
contains docs/ROADMAP.md "Current release: **v27.31.0 — Canonical Absence Ledger & Legacy Retirement**"
...
contains docs/ROADMAP.md "Current release: **v27.31.0 — Canonical Absence Ledger & Legacy Retirement**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.31.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.31.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.31.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.31.0."
contains docs/SECURITY_REVIEW.md "Status: v27.31.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.31.0."
...
contains docs/ROADMAP.md "v27.31.0 — Canonical Absence Ledger & Legacy Retirement — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.31.0//RU"
...
if [[ "$TEST_METHODS" == "625" ]]; then
  ok "test method baseline: 625"
else
  fail "expected 625 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "126" ]]; then
  ok "test class baseline: 126"
else
  fail "expected 126 test classes, found $TEST_CLASSES"
fi
