...
if [[ "$TEST_METHODS" == "1064" ]]; then
  ok "test method baseline: 1064"
else
  fail "expected 1064 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "229" ]]; then
  ok "test class baseline: 229"
else
  fail "expected 229 test classes, found $TEST_CLASSES"
fi
