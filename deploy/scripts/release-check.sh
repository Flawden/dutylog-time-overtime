...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.34.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.34.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.2."
...
contains docs/ROADMAP.md "Current release: **v27.34.2 — Vue Browser Runtime Bundle Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.34.2 — Vue Browser Runtime Bundle Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.34.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.34.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.34.2"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.2."
contains docs/SECURITY_REVIEW.md "Status: v27.34.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.34.2."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.34.2'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.34.2'
...
contains docs/ROADMAP.md "v27.34.2 — Vue Browser Runtime Bundle Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.34.2//RU"
...
if [[ "$TEST_METHODS" == "647" ]]; then
  ok "test method baseline: 647"
else
  fail "expected 647 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "134" ]]; then
  ok "test class baseline: 134"
else
  fail "expected 134 test classes, found $TEST_CLASSES"
fi
