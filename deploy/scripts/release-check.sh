...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.29.3}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.29.3"
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.3."
...
contains docs/ROADMAP.md "Current release: **v27.29.3 — Custom Workspace Today Widget Order Persistence Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.29.3 — Custom Workspace Today Widget Order Persistence Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.29.3"
...
contains docs/SECURITY_REVIEW.md "Status: v27.29.3."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.29.3"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.3."
contains docs/SECURITY_REVIEW.md "Status: v27.29.3."
contains docs/MODULE_CONTRACTS.md "Status: v27.29.3."
...
contains docs/ROADMAP.md "v27.29.3 — Custom Workspace Today Widget Order Persistence Hotfix — current"
...
not_contains src/main/java/ru/daniil/shifts/module/DutyLogModules.java 'ModuleService.PAYROLL'
  ...
  ok "Playwright test baseline: 38"
else
  fail "expected 38 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "614" ]]; then
  ok "test method baseline: 614"
else
  fail "expected 614 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "122" ]]; then
  ok "test class baseline: 122"
else
  fail "expected 122 test classes, found $TEST_CLASSES"
fi
