...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.26.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.26.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.26.2."
...
contains docs/ROADMAP.md "Current release: **v27.26.2 — Canonical Lineage Recovery**"
...
contains docs/ROADMAP.md "Current release: **v27.26.2 — Canonical Lineage Recovery**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.26.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.26.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.26.2"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.26.2."
contains docs/SECURITY_REVIEW.md "Status: v27.26.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.26.2."
...
contains docs/ROADMAP.md "v27.26.2 — Canonical Lineage Recovery — current"
...
if [[ "$TEST_METHODS" == "592" ]]; then
  ok "test method baseline: 592"
else
  fail "expected 592 @Test methods, found $TEST_METHODS"
fi
