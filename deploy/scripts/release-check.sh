...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.23.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.23.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.23.0."
...
contains docs/ROADMAP.md "Current release: **v27.23.0 — External Calendar Sync**"
...
contains docs/ROADMAP.md "Current release: **v27.23.0 — External Calendar Sync**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.23.0"
...
contains e2e/task-modules.spec.js "await expect(page.locator('#view-tasks')).toHaveClass(/moduleHidden/);"
contains e2e/task-modules.spec.js "await expect(page.locator('#view-tasks')).not.toHaveClass(/moduleHidden/);"
not_contains e2e/mobile-layout.spec.js '#tabbar a[data-view="tasks"]'
not_contains e2e/task-details.spec.js '#tabbar a[data-view="tasks"]'
not_contains e2e/task-modules.spec.js '#tabbar a[data-view="tasks"]'
...
contains docs/SECURITY_REVIEW.md "Status: v27.23.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.23.0"
...
contains src/test/java/ru/daniil/shifts/web/ImportantDatesTimezoneOvertimeFrontendContractTest.java "let timeSettingsApplyQueue = Promise.resolve();"
  ...
  ok "Playwright test baseline: 32"
else
  fail "expected 32 Playwright tests, found $E2E_TESTS"
fi
...
if [[ "$TEST_METHODS" == "564" ]]; then
  ok "test method baseline: 564"
else
  fail "expected 564 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "107" ]]; then
  ok "test class baseline: 107"
else
  fail "expected 107 test classes, found $TEST_CLASSES"
fi
