...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.19.4}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.19.4"
contains docs/RELEASE_CHECKLIST.md "Status: v27.19.4."
...
contains docs/ROADMAP.md "Current release: **v27.19.4 — Ghost Button Transition E2E Stabilization Hotfix**"
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.19.4"
...
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.19.4"
