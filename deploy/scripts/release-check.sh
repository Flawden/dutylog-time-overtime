...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.36.7}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.36.7"
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.7."
...
contains docs/ROADMAP.md "Current release: **v27.36.7 — Time Bank Period Toggle Snapshot Stability Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.36.7 — Time Bank Period Toggle Snapshot Stability Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.36.7"
...
contains docs/SECURITY_REVIEW.md "Status: v27.36.7."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.36.7"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.7."
contains docs/SECURITY_REVIEW.md "Status: v27.36.7."
contains docs/MODULE_CONTRACTS.md "Status: v27.36.7."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.36.7'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.36.7'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.36.7//RU'
...
contains docs/ROADMAP.md "v27.36.7 — Time Bank Period Toggle Snapshot Stability Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.36.7//RU"
...
if [[ "$TEST_METHODS" == "721" ]]; then
  ok "test method baseline: 721"
else
  fail "expected 721 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "148" ]]; then
  ok "test class baseline: 148"
else
  fail "expected 148 test classes, found $TEST_CLASSES"
fi
