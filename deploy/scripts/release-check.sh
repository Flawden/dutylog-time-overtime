...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.40.32}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.40.32"
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.32."
...
contains docs/ROADMAP.md "Current release: **v27.40.32 — Functional Parity Sweep II & Mobile Usability Closure**"
...
contains docs/ROADMAP.md "Current release: **v27.40.32 — Functional Parity Sweep II & Mobile Usability Closure**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.40.32"
...
contains docs/SECURITY_REVIEW.md "Status: v27.40.32."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.40.32."
contains docs/SECURITY_REVIEW.md "Status: v27.40.32."
contains docs/MODULE_CONTRACTS.md "Status: v27.40.32."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.40.32-'
  ...
  # v27.40.32 Functional Parity Sweep I
  contains CHANGES.md "v27.40.32 — Functional Parity Sweep I"
  contains README.md "DutyLog v27.40.32 — Functional Parity Sweep I"
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.40.32."
  contains docs/MODULE_CONTRACTS.md "Status: v27.40.32."
  contains docs/SUPPLY_CHAIN.md "Status: v27.40.32."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.32'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=vacation-entitlement-accrual-engine-after-v27.40.32-green'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.40.32."
  contains frontend/generated-lockfile-manifest.txt 'release=27.40.32'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=b41aed15221924e4106ea4c85faf7afa0bf8144ebc670b7ba993f0094c018c71'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=vacation-entitlement-accrual-engine-after-v27.40.32-green'
...
if [[ "$VITEST_TESTS" == "63" ]]; then
  ok "Vitest case baseline: 63"
else
  fail "expected 63 Vitest cases, found $VITEST_TESTS"
fi
