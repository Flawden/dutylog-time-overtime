...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.29.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.29.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.2."
...
contains docs/ROADMAP.md "Current release: **v27.29.2 — Custom Workspace Today Widget Inheritance Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.29.2 — Custom Workspace Today Widget Inheritance Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.29.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.29.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.29.2"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.2."
contains docs/SECURITY_REVIEW.md "Status: v27.29.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.29.2."
...
contains docs/ROADMAP.md "v27.29.2 — Custom Workspace Today Widget Inheritance Hotfix — current"
...
if [[ "$TEST_METHODS" == "612" ]]; then
  ok "test method baseline: 612"
else
  fail "expected 612 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "121" ]]; then
  ok "test class baseline: 121"
else
  fail "expected 121 test classes, found $TEST_CLASSES"
fi
