...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.29.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.29.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.0."
...
contains docs/ROADMAP.md "Current release: **v27.29.0 — Workspace, Layout & Theme Studio**"
...
contains docs/ROADMAP.md "Current release: **v27.29.0 — Workspace, Layout & Theme Studio**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.29.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.29.0."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.29.0"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.29.0."
contains docs/SECURITY_REVIEW.md "Status: v27.29.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.29.0."
...
contains docs/ROADMAP.md "v27.29.0 — Workspace, Layout & Theme Studio — current"
...
if [[ "$TEST_METHODS" == "610" ]]; then
  ok "test method baseline: 610"
else
  fail "expected 610 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "119" ]]; then
  ok "test class baseline: 119"
else
  fail "expected 119 test classes, found $TEST_CLASSES"
fi
