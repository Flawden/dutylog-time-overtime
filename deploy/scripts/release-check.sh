...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.41.6}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.41.6"
contains docs/RELEASE_CHECKLIST.md "Status: v27.41.6."
...
contains docs/ROADMAP.md "Current release: **v27.41.6 — Accounting Integrity Semantics & Actionability Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.41.6 — Accounting Integrity Semantics & Actionability Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.41.6"
...
contains docs/SECURITY_REVIEW.md "Status: v27.41.6."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.41.6."
contains docs/SECURITY_REVIEW.md "Status: v27.41.6."
contains docs/MODULE_CONTRACTS.md "Status: v27.41.6."
...
contains src/test/java/ru/daniil/shifts/web/VueSettingsWorkspaceMigrationFrontendContractTest.java 'document.documentElement.setAttribute(\"data-vue-settings-workspace\", \"ready\")'
  ...
  contains src/main/resources/static/service-worker.js 'dutylog-shell-v27.41.6-'
  ...
  contains frontend/browser-bundle-budget.json '"release": "27.41.6"'
  contains frontend/browser-bundle-budget.json '"maxBytes": 810000'
  contains frontend/browser-bundle-budget.json '"maxGzipBytes": 250000'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=frontend-bundle-segmentation-after-v27.41.6-green'
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.41.6."
  contains docs/MODULE_CONTRACTS.md "Status: v27.41.6."
  contains docs/SUPPLY_CHAIN.md "Status: v27.41.6."
  contains frontend/generated-lockfile-manifest.txt 'release=27.41.6'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=frontend-bundle-segmentation-after-v27.41.6-green'
  ...
  contains docs/RELEASE_CHECKLIST.md "Status: v27.41.6."
  contains frontend/generated-lockfile-manifest.txt 'release=27.41.6'
  contains frontend/generated-lockfile-manifest.txt 'committedLockfileSha256=0ce9f1eeb13ed5e65fd1308d6c6d431fdcfb60aef2b5fea07a226e11da752bad'
  contains frontend/generated-lockfile-manifest.txt 'nextAction=frontend-bundle-segmentation-after-v27.41.6-green'
...
if [[ "$VITEST_TESTS" == "64" ]]; then
  ok "Vitest case baseline: 64"
else
  fail "expected 64 Vitest cases, found $VITEST_TESTS"
fi
