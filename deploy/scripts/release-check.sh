...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.45.0}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.45.0"
contains docs/RELEASE_CHECKLIST.md "Status: v27.45.0."
...
contains docs/ROADMAP.md "Current release: **v27.45.0 — Production Calendar Foundation**"
...
contains docs/ROADMAP.md "Current release: **v27.45.0 — Production Calendar Foundation**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.45.0"
...
contains docs/SECURITY_REVIEW.md "Status: v27.45.0."
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.45.0."
contains docs/SECURITY_REVIEW.md "Status: v27.45.0."
contains docs/MODULE_CONTRACTS.md "Status: v27.45.0."
...
# v27.40.33 Overtime Chart Projection Fixture Contract Hotfix
  ...
  contains docs/SECURITY_REVIEW.md "Status: v27.45.0."
  contains docs/MODULE_CONTRACTS.md "Status: v27.45.0."
  contains docs/SUPPLY_CHAIN.md "Status: v27.45.0."
...
contains src/test/java/ru/daniil/shifts/web/VueCalendarTimelineMigrationFrontendContractTest.java '<SelectedDayPanel v-if=\"dayPanelOpen && viewingSelf\"'
  ...
  contains docs/API.md "129 operations / 135 schemas"
  contains frontend/src/generated/dutylog-api.ts 'Contract: 129 operations, 135 schemas'
...
if [[ "$VITEST_TESTS" == "73" ]]; then
  ok "Vitest case baseline: 73"
else
  fail "expected 73 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "797" ]]; then
  ok "test method baseline: 797"
else
  fail "expected 797 @Test methods, found $TEST_METHODS"
fi
...
contains src/main/java/ru/daniil/shifts/service/TimeCompensationService.java "workNorm.basePlannedMinutes"
...
contains frontend/src/features/payroll/components/PayrollWorkspace.vue "productionCalendarScheduleEffect"
contains frontend/src/features/payroll/components/PayrollWorkspace.vue "v27.45.0 пока не меняет денежную формулу Payroll"
