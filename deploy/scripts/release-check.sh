...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.36.1}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.36.1"
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.1."
...
contains docs/ROADMAP.md "Current release: **v27.36.1 — Vue Browser Timer Handle Type Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.36.1 — Vue Browser Timer Handle Type Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.36.1"
...
contains docs/SECURITY_REVIEW.md "Status: v27.36.1."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.36.1"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.36.1."
contains docs/SECURITY_REVIEW.md "Status: v27.36.1."
contains docs/MODULE_CONTRACTS.md "Status: v27.36.1."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.36.1'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.36.1'
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.36.1//RU'
...
contains docs/ROADMAP.md "v27.36.1 — Vue Browser Timer Handle Type Hotfix — current"
...
contains src/test/java/ru/daniil/shifts/web/VueBrowserTimerHandleTypeHotfixTest.java "class VueBrowserTimerHandleTypeHotfixTest"
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.36.1//RU"
...
if [[ "$VITEST_TESTS" == "26" ]]; then
  ok "Vitest case baseline: 26"
else
  fail "expected 26 Vitest cases, found $VITEST_TESTS"
fi
...
if [[ "$TEST_METHODS" == "689" ]]; then
  ok "test method baseline: 689"
else
  fail "expected 689 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "143" ]]; then
  ok "test class baseline: 143"
else
  fail "expected 143 test classes, found $TEST_CLASSES"
fi
