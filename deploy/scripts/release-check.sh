...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.28.2}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.28.2"
contains docs/RELEASE_CHECKLIST.md "Status: v27.28.2."
...
contains docs/ROADMAP.md "Current release: **v27.28.2 — Calendar Persistence Reload Readiness Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.28.2 — Calendar Persistence Reload Readiness Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.28.2"
...
contains docs/SECURITY_REVIEW.md "Status: v27.28.2."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.28.2"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.28.2."
contains docs/SECURITY_REVIEW.md "Status: v27.28.2."
contains docs/MODULE_CONTRACTS.md "Status: v27.28.2."
...
contains docs/ROADMAP.md "v27.28.2 — Calendar Persistence Reload Readiness Hotfix — current"
...
if [[ "$TEST_METHODS" == "604" ]]; then
  ok "test method baseline: 604"
else
  fail "expected 604 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "117" ]]; then
  ok "test class baseline: 117"
else
  fail "expected 117 test classes, found $TEST_CLASSES"
fi
