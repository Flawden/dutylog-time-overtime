...
VERSION="${DUTYLOG_RELEASE_VERSION:-27.34.3}"
ERRORS=0
STATIC_JS=(
  "js/10-core.js"
...
contains docs/API.md "# DutyLog API v27.34.3"
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.3."
...
contains docs/ROADMAP.md "Current release: **v27.34.3 — Vue Shell E2E Navigation Compatibility Hotfix**"
...
contains docs/ROADMAP.md "Current release: **v27.34.3 — Vue Shell E2E Navigation Compatibility Hotfix**"
contains docs/REGRESSION_TEST_BASELINE.md "Current extension: v27.34.3"
...
contains docs/SECURITY_REVIEW.md "Status: v27.34.3."
...
contains docs/RELEASE_CHECKLIST.md "git tag -a v27.34.3"
...
contains docs/RELEASE_CHECKLIST.md "Status: v27.34.3."
contains docs/SECURITY_REVIEW.md "Status: v27.34.3."
contains docs/MODULE_CONTRACTS.md "Status: v27.34.3."
...
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.css?v=27.34.3'
contains src/main/resources/static/index.html '/vue/dutylog-vue-app-shell.js?v=27.34.3'
...
contains docs/ROADMAP.md "v27.34.3 — Vue Shell E2E Navigation Compatibility Hotfix — current"
...
contains e2e/external-calendar-sync.spec.js 'PRODID:-//DutyLog//Time and Overtime 27.34.3//RU'
...
contains src/test/java/ru/daniil/shifts/web/CalendarSyncControllerTest.java "PRODID:-//DutyLog//Time and Overtime 27.34.3//RU"
...
if [[ "$TEST_METHODS" == "648" ]]; then
  ok "test method baseline: 648"
else
  fail "expected 648 @Test methods, found $TEST_METHODS"
fi
if [[ "$TEST_CLASSES" == "135" ]]; then
  ok "test class baseline: 135"
else
  fail "expected 135 test classes, found $TEST_CLASSES"
fi
