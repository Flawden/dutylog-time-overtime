...
export function createSettingsWorkspaceApi(client: DutyLogGeneratedApiClient = createGeneratedDutyLogApiClient()) {
  return Object.freeze({
    ...
    async legacyShiftPreview() { return client.request("previewLegacyShiftMigration"); },
    ...
    async legacyTaskDeadlinePreview() { return client.request("previewLegacyTaskDeadlineMigration"); },
