...
const text = computed(() => language.value === "en" ? {
  eyebrow: "Schedules", title: "Templates and people profiles", hint: "Build repeating cycles and read-only people profiles without overlaying another schedule on yours.", templates: "Schedule templates", templatesHint: "Up to 64 steps in a cycle.", addTemplate: "＋ New", name: "Name", description: "Description", alignment: "Alignment", cycleStart: "from anchor date", weekday: "by weekday (7 steps)", addShift: "Add shift", addStep: "＋ Add", saveTemplate: "Save template", cancel: "Cancel", remove: "remove", delete: "Delete", layers: "People profiles", layersHint: "Switch the whole calendar to a family member or teammate instead of stacking schedules.", addLayer: "＋ New profile", color: "Color", timezone: "Timezone", template: "Template", anchor: "Anchor date", start: "Show from", end: "Stop after", visible: "show in calendar switcher", saveLayer: "Save profile", emptyLayers: "Add the first read-only people profile.", system: "system", custom: "custom",
} : {
  eyebrow: "Графики", title: "Шаблоны и профили людей", hint: "Повторяющиеся циклы и read-only профили: календарь переключается на человека целиком, без наложения графиков.", templates: "Шаблоны графика", templatesHint: "До 64 элементов в цикле.", addTemplate: "＋ Новый", name: "Название", description: "Описание", alignment: "Привязка", cycleStart: "от опорной даты", weekday: "по дням недели (7 шагов)", addShift: "Добавить смену", addStep: "＋ В цикл", saveTemplate: "Сохранить шаблон", cancel: "Отмена", remove: "убрать", delete: "Удалить", layers: "Профили людей", layersHint: "Например: Сашка, любимка, напарник. Выбор профиля переключает весь календарь.", addLayer: "＋ Новый профиль", color: "Цвет", timezone: "Часовой пояс", template: "Шаблон", anchor: "Опорная дата", start: "Начало показа", end: "Остановить после", visible: "показывать в переключателе календаря", saveLayer: "Сохранить профиль", emptyLayers: "Добавьте первый профиль близкого человека.", system: "встроенный", custom: "пользовательский",
});
...
async function deleteLayer(): Promise<void> {
  if (layerId.value == null || !window.confirm(language.value === "en" ? "Delete this profile?" : "Удалить профиль?")) return;
