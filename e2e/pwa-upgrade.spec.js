...
test('PWA activation removes a previous release cache before claiming the v27.40.16 shell', async ({ browser, baseURL }) => {
  ...
  try {
    ...
    expect(cacheNames.some(name => name.startsWith('dutylog-shell-v27.40.16-'))).toBe(true);
