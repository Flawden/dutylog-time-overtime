...
test('PWA activation removes a previous release cache before claiming the v27.40.8 shell', async ({ browser, baseURL }) => {
  ...
  try {
    ...
    expect(cacheNames.some(name => name.startsWith('dutylog-shell-v27.40.8-'))).toBe(true);
