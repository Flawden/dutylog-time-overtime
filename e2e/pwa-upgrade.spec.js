...
test('PWA activation removes a previous release cache before claiming the v27.38.7 shell', async ({ browser, baseURL }) => {
  ...
  try {
    ...
    expect(cacheNames.some(name => name.startsWith('dutylog-shell-v27.38.7-'))).toBe(true);
