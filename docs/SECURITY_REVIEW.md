...
Status: v27.45.1. SYSTEM_ACTUAL_WORK rows are non-editable projections in the client and remain mutation-guarded by the backend; cross-date Actual Work is still owner-scoped and accounting-period locked across its full start/end range.
