...
- [ ] `./deploy/scripts/smoke-test.sh https://domain` passes and confirms `v23.0` static assets.
...
- [ ] `Система` page is visible to administrator and shows server version `23.0`.
