...
Current extension: v27.42.0 keeps the v27.41.8 shared runtime split and all v27.41.7 browser ceilings unchanged, while aligning the one stale Java bundle-gate source contract with the segmented entry/per-chunk/total raw+gzip model. Inventory remains 163 Java test classes / 791 @Test methods / 48 Chromium Playwright scenarios / 64 Vitest cases, OpenAPI 124/130 and Flyway V47.
