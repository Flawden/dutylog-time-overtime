...
- Java baseline remains **792** tests / **164** classes.
- Playwright baseline remains **48**.
- Vitest source baseline advances **70 -> 71**.
- OpenAPI remains **126 operations / 132 schemas**.
- Flyway remains **V48**.
...
- Java baseline remains **792** tests / **164** classes.
- Playwright baseline remains **48**.
- Vitest source baseline advances **71 -> 72**.
- OpenAPI remains **126 operations / 132 schemas**.
- Flyway remains **V48**.
