...
Current extension: v27.41.4 preserves the green Calendar/Today/overtime runtime and adds desktop/workflow source contracts for bounded layouts, relevant-first Absence sorting, actionable integrity rows, FIFO allocation readability, Notes Focus Mode and canonical time-off wording. Inventory remains 163 Java test classes / 790 @Test methods / 48 Chromium Playwright scenarios / 64 Vitest cases, OpenAPI 124/130 and Flyway V47.
