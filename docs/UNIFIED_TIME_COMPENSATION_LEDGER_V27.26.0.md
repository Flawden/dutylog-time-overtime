...
Next product stage: `v27.27.0 — Ledger Integrity & Approval Workflow`; `v27.28.0 — Payroll Foundation` follows after the ledger gains approvals, immutable reversals, reconciliation and period closing.
