...
Status: Vue owns the shell, all user-facing screens and offline/sync presentation after readiness; first-run onboarding is the only intentionally live post-ready legacy presentation exception, DutyLog v27.40.26.
...
First-run onboarding is the only intentionally live post-ready legacy presentation exception after v27.40.26.
