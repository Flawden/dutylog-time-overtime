...
Q-01–Q-05 реализованы. Gate A принимается для `v27.36.0` только после полного зелёного CI/staging `v27.35.6`; до этого доменная миграция не начинается.
