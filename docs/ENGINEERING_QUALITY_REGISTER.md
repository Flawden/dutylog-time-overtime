...
|---|---|---|---|---|---|
| Q-01 | Frontend lockfile, `npm ci`, pinned Node/npm | `v27.35.0` | каждый CI/Docker build | clean checkout даёт одинаковый dependency tree | DONE |
...
Q-01–Q-05 закрыты в `v27.35.0`; Gate A открыт для `v27.36.0`.
