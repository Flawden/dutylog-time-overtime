...
Статус: v27.9.3 добавляет preflight-проверку ёмкости до создания/изменения отгула и синхронизирует CI-контракты с утверждённым UX v27.9.2. Атомарная пересборка FIFO и защита журнала остаются основой.
