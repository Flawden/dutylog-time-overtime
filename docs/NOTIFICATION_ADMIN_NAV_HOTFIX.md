...
`release-check.sh` verifies that the notification header uses the dedicated v27.0-rc4 layout and that the admin view contains the side navigation anchors.
