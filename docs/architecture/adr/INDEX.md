...
|---|---|---|---|
| [ADR-001](ADR-001-vue-strict-typescript-target.md) | Vue 3 + strict TypeScript is the only frontend target | accepted | v27.35.0 |
| [ADR-002](ADR-002-monorepo-single-application-image.md) | One monorepo and one production application image | accepted | v27.35.0 |
