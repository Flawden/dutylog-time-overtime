# DutyLog API v27.21.1

Проект: **DutyLog: Time & Overtime**.

v27.21.1 не меняет HTTP API. Базовый v27.21.0 аддитивно добавляет owner-scoped шаблоны графика и календарные слои. Существующие calendar/day/task/note/event payload'ы не меняются. Flyway V39 создаёт отдельные таблицы правил; датированные смены и исторические данные не переписываются.
