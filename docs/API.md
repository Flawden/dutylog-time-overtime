# DutyLog API v27.39.2

`v27.39.2` is a Maven source-contract alignment follow-up to the v27.39.0 Settings migration and v27.39.1 strict-TypeScript fix. It changes no HTTP/OpenAPI contract; the generated client remains **118 operations / 120 schemas** with hash `91b48b10fa56`, and Flyway remains V47.
