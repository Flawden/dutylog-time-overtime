# DutyLog API v27.40.5

`v27.40.5` changes no HTTP/OpenAPI shape. It aligns the strict Calendar/Timeline source contract with the now-explicit `CalendarDaySection` type used by the native Vue selected-day domain; OpenAPI remains **118 operations / 120 schemas** with hash `91b48b10fa56`, and Flyway remains V47.
