# DutyLog API v27.40.11

`v27.40.11` changes no HTTP/OpenAPI shape. It retires hidden legacy navigation DOM as shell state and keeps routing/module/workspace changes entirely in the frontend compatibility layer; OpenAPI remains **118 operations / 120 schemas** with hash `91b48b10fa56`, and Flyway remains V47.
