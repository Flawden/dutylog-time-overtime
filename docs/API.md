# DutyLog API v27.40.0

`v27.40.0` changes no HTTP/OpenAPI or backend business contract. It moves the final Time, Schedule/Calendar Layers and Notifications Settings islands onto the already-generated `/api/v1/*` operations and removes their DOM compatibility bridge. OpenAPI remains **118 operations / 120 schemas** with hash `91b48b10fa56`; Flyway remains V47.
